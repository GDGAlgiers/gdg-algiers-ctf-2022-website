...
const About = () => {
    return (
        <section id="about">
            ...
            <p
                className={`${containerStyles.textShadow} text-center text-lg leading-[48px] px-[20px] mb-24 lg:mb-36 md:text-2xl  md:leading-[86px] md:px-[96px] lg:text-3xl  lg:leading-[96px] lg:px-[164px]  2xl:text-4xl 2xl:px-[245px] 2xl:leading-[144px]`}
            >
