...
const Footer = () => {
    const Social=[{icon:<RiFacebookCircleLine className="Social" />,url:'https://web.facebook.com/GDGAlgiers'},{icon:<FaInstagram className="Social" />,url:'https://www.instagram.com/gdg_algiers/'},{icon:<FiTwitter className="Social" />,url:'https://twitter.com/gdg_algiers'},{icon:<RiLinkedinBoxLine className="Social" />,url:'https://www.linkedin.com/company/gdg-algiers/'}];
    return (
