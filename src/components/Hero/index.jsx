        ...
        <section id="home">
            ...
            <div className="py-[96px] pl-[39px] pr-[39px] lg:py-[121px] lg:pl-[66px] lg:pr-[0]">
                <div className="flex flex-col gap-[96px] lg:gap-[64px] lg:flex-row">
                    <div className="order-last lg:order-first flex flex-col gap-[48px] lg:gap-[56px] 2xl:gap-[82px]">
                        <h1
                            className={`${containerStyles.textShadow} text-white-lighter text-[40px] text-center lg:text-left lg:text-[70px] 2xl:text-[120px] 2xl:font-extrabold lg:leading-[96px] 2xl:leading-[144px]`}
                        >
